<?php 
    ...
    $Products = $init->DisplayProductsByCategory(2);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
...
<nav class="navbar font-mono">
    ...
    <section style="height: 100vh" class="phone-category my-5 mx-5" id="deals">
        ...
        <h2 class="my-10 mx-7 font-semibold text-neutral-700 font-sans text-2xl">Best phone's deals 📱</h2>
        ...
        <div class="deals-list categories-list grid lg:grid-cols-4 gap-10 m-auto">
            ...
            <div class="product" >
                ...
                <div class="button my-6 mx-3">
                    <button class="border-2 border-stone-800 rounded-full px-3 py-1 hover:text-lime-700 hover:border-lime-800" id="cart-btn"><span class="font-mono text-sm">Add to cart</span></button>
                </div>
