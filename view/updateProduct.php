<?php 
    ...
    $productToUpdate = $Product->DisplayProductById($_GET['productid']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
                                ...
                                <form action="<?= URLROOT ?>/controller/Products.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="grid gap-y-2 text-sm grid-cols-1 md:grid-cols-5 my-8">
                                        <div class="md:col-span-5">
                                            ...
                                            <input type="text" name="Product_name" id="Product_name" class="text-black h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?=$productToUpdate->produit_name ?>" />
                                        </div>
                                        ...
                                        <div class="md:col-span-5">
                                            ...
                                            <input name="Product_description" type="text" id="Product_description" class="text-black h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?=$productToUpdate->produit_description ?>" />
                                        </div>

                                        <div class="md:col-span-5">
                                            <label for="Product_price" class="text-black">Product price</label>
                                            <input name="Product_price" type="number" id="Product_price" class="text-black h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?=$productToUpdate->prix_achat ?>"/>
                                        </div>

                                        <div class="md:col-span-5">
                                            <label for="Product_offer" class="text-black">Product Offer</label>
                                            <input name="Product_offer" type="number" id="Product_offer" class="text-black h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?=$productToUpdate->prix_offer ?>"/>
                                        </div>

                                        <div class="md:col-span-5">
                                            <label for="Product_price_final" class="text-black">Product price final</label>
                                            <input type="text" name="Product_price_final" id="Product_product_final" class="text-black h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?=$productToUpdate->prix_final ?>" />
                                        </div>

                                        <div class="md:col-span-5">
                                            <label for="Product_Quantity" class="text-black">Product Quantity</label>
                                            <input name="Product_Quantity" type="number" id="Product_Quantity" class="text-black h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?=$productToUpdate->produit_quantite ?>"/>
                                        </div>

                                        <div class="md:col-span-5">
                                            <label for="Product_codebar" class="text-black">Product codebar</label>
                                            <input name="Product_codebar" type="number" id="Product_codebar" class="text-black h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="<?=$productToUpdate->produit_codebar ?>"/>
                                        </div>
