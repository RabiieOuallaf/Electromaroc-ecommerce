...
<body>
    ...
    <section class="categories container " id="categories">
        ...
        <div class="categories-list flex justify-evenly m-auto mt-3 overflow-x-auto">
            ...
            <!-- Category -->
            <div class="computer-cate cursor-pointerv hover:animate-pulse" onClick="location.href='/computers'">
            ...
            <!-- Category -->
            <div class="mentor-cate cursor-pointer hover:animate-pulse" onclick="location.href='/mentor'">
            ...
            <!-- Category -->
            <div class="gaming-cate cursor-pointer hover:animate-pulse" onClick="location.href='/gaming'">
